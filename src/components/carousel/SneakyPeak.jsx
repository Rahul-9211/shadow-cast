 ...
 */
 ...
 const SneakyPeek = ({ slider, type , SlideToShow, sneakyPeek }) => {
     ...
     const settings = {
         slidesToShow: SlideToShow ? 3 : 2.5,
         slidesToScroll: 1,
         dots: false,
         swipeToSlide: true,
         infinite: false,
         ...
         responsive: [
             ...
             },
             {
                 breakpoint: 991,
                 settings: {
                     slidesToShow: SlideToShow ? 3:  2.15,
                 },
             },
             {
                 breakpoint: 600,
         ...
         <Slider
             ...
             {slider.map((slide, index) =>
                 <div className="slick-slide px-2.5" key={index}>
                     ...
                     <div>
                         {type !== "channel" && <><div className={`aspect-[456/239] relative ${!sneakyPeek ? "rounded-2xl" : ""} bg-[#2B2B2B] mb-2.5`}>
                            ...
                            {sneakyPeek ? "" : <> <p className='mb-2 text-sm'>{slide?.title}</p>
