...
const SearchResultItem = ({ text, searchTerm, onClick }) => {
  ...
  return (
    <li
      ...
      className="cursor-pointer hover:bg-white/[0.2] py-[23px] text-white font-bold text-sm h-10 flex items-center px-[23px] c"
    />
  );
};
...
const AfterLogin = () => {
  ...
  const handleInputChange = (event) => {
    ...
    const results = ["Apartments", "My Assets"].filter((item) =>
  ...
  return (
    <>
      <Box
        className={`w-full ${
          pathname == "/" ? "bg-black" : "border-white/[0.1] border-[0.6px]"
        } ${
          sticky.isSticky ? "bg-dark/[0.90] " : ""
        } py-2 md:py-4 px-4 lg:px-6 transition-all backdrop-blur-[2px] sticky top-0 z-50`}
        ref={headerRef}
      >
            ...
            <Box className="menu-bar-before flex justify-between items-center w-full">
              <Box>
                <ul className="flex justify-between items-center text-sm">
                  <li className="mx-2 lg:mx-4 xl:mx-7">
                    <NavLink
                      to="/marketplace"
                      className="text-white font-semibold py-2 px-1 border-b-2 border-transparent inline-block"
                    >
                      Marketplace
                    </NavLink>
                  </li>
              ...
              <Box>
                <ul className="flex justify-between items-center text-sm">
                  <li className="mx-2 lg:mx-4">
                    <div
                      ref={searchRef}
                      className="relative w-30 lg:w-72 mx-auto py-4"
                    >
                      <div className="relative rounded-lg bg-black shadow border border-solid border-1 border-[#7A7A7A]">
                        <div className="absolute top-0 left-2 flex items-center h-full pl-1">
                          ...
                          >
                            <path
                              d="M10.4167 9.16667H9.75834L9.525 8.94167C10.3699 7.96169 10.8343 6.71058 10.8333 5.41667C10.8333 4.34535 10.5157 3.2981 9.92046 2.40733C9.32527 1.51656 8.4793 0.822296 7.48954 0.412322C6.49977 0.00234696 5.41066 -0.104921 4.35993 0.104082C3.3092 0.313085 2.34404 0.828973 1.58651 1.58651C0.828973 2.34404 0.313085 3.3092 0.104082 4.35993C-0.104921 5.41066 0.00234696 6.49977 0.412322 7.48954C0.822296 8.4793 1.51656 9.32527 2.40733 9.92046C3.2981 10.5157 4.34535 10.8333 5.41667 10.8333C6.75834 10.8333 7.99167 10.3417 8.94167 9.525L9.16667 9.75834V10.4167L13.3333 14.575L14.575 13.3333L10.4167 9.16667ZM5.41667 9.16667C3.34167 9.16667 1.66667 7.49167 1.66667 5.41667C1.66667 3.34167 3.34167 1.66667 5.41667 1.66667C7.49167 1.66667 9.16667 3.34167 9.16667 5.41667C9.16667 7.49167 7.49167 9.16667 5.41667 9.16667Z"
                              fill="#777777"
                            />
                          </svg>
                        </div>
                  ...
                  <li className="mx-4 cursor-pointer">
                    <div
                      className="p-3 text-white-700 rounded-full text-base font-semibold"
                      style={{ backgroundColor: "#40351A" }}
                      onClick={handleClick}
                  ...
                  <div className="flex flex-col">
                    ...
                    <ul className="flex flex-col gap-4 border-t border-[#383838] pt-3">
                      <li>
                        <NavLink
                          to="/me"
                          className="font-semibold text-white block py-3 px-3.5 rounded hover:bg-white/[0.10]"
                        >
                          My Profile
                        </NavLink>
                      </li>
                ...
                <ul className="flex justify-end items-center text-sm">
                  ...
                  <li className="ml-3">
                    <button
                      ...
                      className={`menu-icon text-white w-[34px] h-[34px] flex item-center gap-[0.563rem] flex-col items-center justify-center focus:outline-none ${
                        handleToggleHamburger ? "active" : ""
                      }`}
                    >
        ...
        <div className="inner-content relative mt-28 md:mt-32">
          <ul className="flex flex-col gap-5 justify-between items-center relative z-50">
            <li>
              <NavLink
                to="/marketplace"
                onClick={() => sethandleToggleHamburger(false)}
