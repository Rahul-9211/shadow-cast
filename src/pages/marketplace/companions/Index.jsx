...
const Index = () => {
  return (
    <div data-testid="__companion_landing_page" className="__companion_landing_page px-2">
      <ShadowFrame
      ...
      <div className="__butler__slider__container py-[40px] max-[768px]:py-[10px] relative z-[10]">
        <div data-testid="slider-card" className="__slider_card_container flex gap-[20px] overflow-x-scroll py-[10px]">
