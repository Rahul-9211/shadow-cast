        ...
        <Box className="md:h-[100px] h-[65px] flex items-center bg-black backdrop-blur-2 px-6">
          ...
          <Box className="menu-bar-before flex justify-between items-center w-full">
            <Box>
              <ul className="flex justify-between items-center text-sm">
                <li className="mx-7">Marketplace</li>
            ...
            <Box>
              <ul className="flex justify-between items-center text-sm">
                <li className="mx-3">
                  <div ref={searchRef} className="relative w-80 mx-auto py-4">
                    <div className="relative rounded-full bg-black shadow rounded-full border border-[#777]">
                      <div className="absolute top-0 left-2 flex items-center h-full pl-1 ">
                        <SearchIcon className="text-gray-500" />
                      </div>
                      <input
                        type="text"
                        className="w-full py-2 pl-12 pr-3 text-xs text-white-700 outline-none bg-white bg-opacity-5"
                        placeholder="Search..."
                        value={searchTerm}
                ...
                <li className="mx-3"><div className="p-3 text-white-700 rounded-full text-base font-semibold" style={{ backgroundColor: "#40351A" }} >SN</div></li>
              </ul>
            </Box>
          </Box>
          ...
          <Box className="menu-bar-after flex justify-between items-center w-full">
            ...
            <Box>
              ...
              <ul className="flex justify-between items-center text-sm">
                <li className="mx-4">
                  <ShoppingCartIcon data-testid="shopping-cart-icon" className="text-white" />
                </li>
                <li className="mx-4">
                  <div className="p-3 text-white rounded-full text-[15px] font-semibold" style={{ backgroundColor: "#40351A" }} >SN</div>
                </li>
                <li className="mx-4 cursor-pointer" >
                  <MenuIcon onClick={handleHamburger} data-testid="menu-icon" className="text-white" />
                </li>
              </ul>
            </Box>
          </Box>
