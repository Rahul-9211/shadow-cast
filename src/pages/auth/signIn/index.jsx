            ...
            <Box className="text-white max-w-[500px] mx-auto">
                ...
                <form className="auth-form mb-5">
                    <div className="mb-4">
                        ...
                        <div className="mt-2">
                            <input type="email" name="email" className={`rounded-lg w-full bg-transparent border border-white focus:border-[#51A2FF] font-normal py-3 px-5 leading-normal font-semibold outline-none ${!isEmailValid ? '!border-error' : ''}`} id="email" value={formData.email} onChange={handleInputChange}/>
                            {!isEmailValid && formErrors.email && (<span className="text-error font-inter text-sm">{formErrors.email}</span>)}
                        </div>
                    </div>
                    ...
                    <button type="submit" className="font-bold rounded-lg btn-gradient w-full text-black py-3 px-5" onClick={handleSubmit}>Sign In</button>
                </form>
