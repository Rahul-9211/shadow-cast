...
const Premium = ({ title, price, plan, handleData }) => {
    const handleClick = () => {
        handleData('Premium')
    }
    return (
        <>
            ...
            <button type="button" onClick={handleClick} className="font-bold rounded-lg btn-gradient w-full text-black py-3 px-5 mt-10 flex justify-center gap-2 items-center">
