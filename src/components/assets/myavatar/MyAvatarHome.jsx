...
const MyAvatarHome = () => {
  ...
  return (
    <div data-testid="my-avatarHome-main" className="__myavatar_container_main px-[15px] py-[35px] flex flex-col max-[768px]:flex-col max-[768px]:p-0 max-[1280px]:py-[25px]">
