...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      console.log(
        "🚀 ~ file: index.jsx:111 ~ handleSubmit ~ payload:",
        payload
      );
    ...
    <Box className="w-full max-w-[700px] rounded-lg border border-[#363636] p-5 md:p-[32px] lg:p-[58px] signin-form">
      <Box className="text-white max-w-[500px] mx-auto">
        ...
        <form className="auth-form mb-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="flex items-center justify-center font-bold rounded-lg btn-gradient w-full text-black py-3 px-5"
            disabled={!isFormValid()}
          >
            Create my account {btnLoaderStatus ? <BtnLoader /> : ""}
          </button>
        </form>
