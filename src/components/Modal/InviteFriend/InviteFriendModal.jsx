...
const InviteFriendModal = ({ handleModalStatus }) => {
  ...
  return (
    <>
      ...
      <div data-testid="invite-friend-modal" className="__invite_search_component hs-overlay flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-[9999] outline-none focus:outline-none max-[768px]:p-[20px]">
